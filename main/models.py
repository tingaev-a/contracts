...
class Contract(models.Model):
    ...
    subject = models.CharField(max_length=255, verbose_name="Объект договора", null=True)
    date_start = models.DateField(verbose_name="Дата начала")
    date_end = models.DateField(verbose_name="Дата окончания")
    contract_type = models.ForeignKey(
        ContractType,
        on_delete=models.PROTECT,
        related_name='contracts',  # Изменено related_name
        verbose_name="тип договора"
    )
    organization = models.ForeignKey(  # Изменено на ForeignKey
        Organization,  # Предполагаемая модель контрагентов
        on_delete=models.PROTECT,
